  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8">
      <div className="flex items-center justify-between border-b border-cyan-500/20 pb-4">
        ...
        <div className="px-3 py-1 bg-cyan-500/10 border border-cyan-500/20 rounded text-[10px] text-cyan-400 font-bold tracking-widest uppercase">Shell: ZSH</div>
      </div>
        ...
        <div className="space-y-4">
              ...
              {THEMES.map(theme => (
                <button
                  ...
                  className={`p-4 rounded-lg border transition-all text-center ${
                    selected.name === theme.name ? 'border-cyan-500 bg-cyan-500/10' : 'border-cyan-500/10 bg-slate-900 hover:border-cyan-500/30'
                  }`}
                >
                  <span className={`text-[10px] font-black uppercase tracking-widest ${selected.name === theme.name ? 'text-cyan-400' : 'text-slate-500'}`}>
                    {theme.name}
                  </span>
                </button>
              ))}
          ...
          <div className="glass-panel p-6 rounded-xl border border-cyan-500/20 bg-slate-900/50">
            <div className="flex items-center justify-between mb-4">
              <span className="text-[10px] font-black text-cyan-800 uppercase tracking-widest">Configuration Payload</span>
          ...
          <div className="glass-panel rounded-xl border border-cyan-500/20 bg-slate-950 flex flex-col flex-1 overflow-hidden shadow-2xl">
            ...
            <div className="p-8 font-mono text-sm space-y-4">
              ...
              <div className="text-slate-500 text-xs">
                ...
                drwxr-xr-x  3 user  staff  96 Feb 19 14:20 ..<br/>
                -rw-r--r--  1 user  staff  12 Feb 19 14:20 config.zsh<br/>
              </div>
            </div>
