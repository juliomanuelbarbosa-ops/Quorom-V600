...
const DIRECTORY_DATA: DirectoryNode[] = [
  {
    ...
    description: "Matt Wolfe's curated database of the best AI tools.",
    type: 'Tools',
  },
  {
    name: 'Futurepedia',
  ...
  },
  {
    ...
    description: 'Comprehensive manifest of global AI directories.',
    type: 'Meta',
  },
  {
    name: "There's an AI for That",
    url: 'https://theresanaiforthat.com',
    description: 'The most comprehensive AI tracker in the world.',
    type: 'Tools',
  },
  {
    name: 'Hugging Face',
    url: 'https://huggingface.co',
    description: 'The central platform for open-source AI models and datasets.',
    type: 'Models',
  },
  {
    name: 'AIXploria',
    url: 'https://www.aixploria.com',
    description: 'Elegant directory focusing on European and global AI projects.',
    type: 'Meta',
  },
  {
    name: 'Papers with Code',
    url: 'https://paperswithcode.com',
    description: 'The state-of-the-art in machine learning research with source code.',
    type: 'Dev',
  },
  {
    name: 'AlternativeTo AI',
    url: 'https://alternativeto.net/category/ai/',
    description: 'Crowdsourced database of AI software alternatives.',
    type: 'Tools',
  },
  {
    name: 'Vercel AI SDK',
    url: 'https://sdk.vercel.ai',
    description: 'The best directory for building and exploring AI-powered UIs.',
    type: 'Dev',
  },
];
...
const NeuralLibrary: React.FC = () => {
  ...
  const filtered = DIRECTORY_DATA.filter(
    (d) =>
        ...
        {filtered.map((node, idx) => (
          ...
          >
            <div className="flex justify-between items-start mb-4">
              <span
                className={`px-2 py-0.5 rounded text-[8px] font-black tracking-widest uppercase border ${
                  node.type === 'Meta'
              ...
              <a
                ...
                className="text-indigo-900 hover:text-indigo-400 transition-all"
              >
